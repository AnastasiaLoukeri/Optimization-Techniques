...
obj_func = (1/3)*x^2+3*y^2;

% Simulation Parameters
tol_val = 0.001; % Tolerance for stopping criteria

% FOR DIFFERENT VALUES OF GAMMA CHANGE THE VARIABLE 'step_val' INSIDE THE
% grad_descent FUNCTION.
fprintf('Processing Case 1: Start Point (-1, -1)...\n');
[~, iters1, path_u1, path_v1, step_hist1] = grad_descent(obj_func, [-1, -1], tol_val, x, y);
...
function [curr_pos, iter_count, trace_u, trace_v, trace_gamma] = grad_descent(func_sym, start_pos, tol, sym_u, sym_v)
